#ifndef LITE_LIME_PLUGIN_API
#define LITE_LIME_PLUGIN_API
/* 
The lite_lime plugin API is quite simple. Any shared library can be a plugin file, so long
as it has an entrypoint that looks like the following, where xxxxx is the plugin name:

#include "lite_lime_plugin_api.h"

int lua_open_lite_lime_xxxxx(lua_State* L, void* XL) {
  lite_lime_plugin_init(XL);
  ...
  return 1;
}
...
#!/bin/sh
echo "#ifndef LITE_LIME_PLUGIN_API"
echo "#define LITE_LIME_PLUGIN_API"
echo "/* "
echo "The lite_lime plugin API is quite simple. Any shared library can be a plugin file, so long"
echo "as it has an entrypoint that looks like the following, where xxxxx is the plugin name:"
echo
echo '#include "lite_lime_plugin_api.h"'
echo
echo "int lua_open_lite_lime_xxxxx(lua_State* L, void* XL) {"
echo "  lite_lime_plugin_init(XL);"
echo "  ..."
echo "  return 1;"
echo "}"
echo
...
echo "static void lite_lime_plugin_init(void* XL) {"
...
static void lite_lime_plugin_init(void* XL) {
